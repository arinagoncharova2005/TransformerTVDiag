...
labels_path = 'TransTVDiag/data/gaia/gaia.csv'
pkl_split_dir = '/GAIA_data/data/gaia/pkl/split'

# drain_miner_path = 'data/gaia/drain/drain.pkl'
# drain_stats_path = 'data/gaia/drain/statistics.csv'
drain_miner_path = 'TransTVDiag/extractor/drain/drain.pkl'
drain_stats_path = 'TransTVDiag/extractor/drain/statistics.csv'

nodes_pkl_path = '/GAIA_data/data/gaia/raw/nodes.pkl'

events_output_path = '/GAIA_data/data/gaia/events/log.json'
