...
trace_csv_input_path = '/GAIA_data/data/gaia/csv/trace.csv'
labels_input_path = 'TransTVDiag/data/gaia/gaia.csv'
output_file = '/GAIA_data/data/gaia/pkl/normal_traces.pkl'
