...
trace_input_dir = "/GAIA_data/MicroSS/trace"
trace_output_dir = "/GAIA_data/data/gaia/csv/trace.csv"

log_input_dir = "/GAIA_data/MicroSS/business"
log_output_dir = "/GAIA_data/data/gaia/csv/log.csv"

log_csv_split_dir = "/GAIA_data/data/gaia/csv" 

metric_input_dir = "/GAIA_data/MicroSS/metric"

dataset_pkl_output_path = "/GAIA_data/data/gaia/pkl/gaia.pkl" 

splitted_dataset_path = '/GAIA_data/data/gaia/pkl/split/'
...
if __name__ == '__main__':
    # print('start processing traces')
    # trace_df = process_traces()
    # print('finish processing traces')
    ...
    label_df = pd.read_csv("TransTVDiag/data/gaia/label_15_85.csv")
    ...
    trace_df = pd.read_csv(trace_output_dir)
    log_df = pd.read_csv(log_output_dir)
    
    log_cache = LogCache(log_csv_split_dir, 2)

    print('start processing metrics')
    # reduce the IO count
    metric_fs = {}
    for f in os.listdir(metric_input_dir):
        if f.startswith("zookeeper") or f.startswith("system") or f.startswith("."):
            continue 
    ...
    print('finish processing metrics')
